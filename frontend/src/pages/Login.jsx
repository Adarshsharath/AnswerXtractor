      ...
      >
        <div className="glass-morphism rounded-3xl p-8 shadow-2xl backdrop-blur-2xl border border-white/10 hover-glow">
          ...
          <motion.div variants={itemVariants} className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2 font-medium">An AI That Reads For You</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mt-8 text-center bg-white/5 py-4 rounded-2xl border border-white/5">
            <p className="text-gray-400 text-sm">
              ...
              <Link to="/register" className="text-primary-400 hover:text-primary-300 font-bold transition-colors underline-offset-4 hover:underline">
                Sign up
              </Link>
            </p>
          </motion.div>
